...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('📤 Frontend API route - отправка сообщения с оплатой:', body)
    ...
    console.log('🔄 Отправка к Strapi:', `${process.env.NEXT_PUBLIC_API_URL}/invoices/send-payment-message`)

    const strapiResponse = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/invoices/send-payment-message`, {
      method: 'POST',
      headers: {
