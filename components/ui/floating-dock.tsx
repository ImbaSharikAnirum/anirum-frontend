...
const FloatingDockMobile = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "mx-auto block h-12 items-end gap-2 rounded-2xl bg-gray-50 px-2 pb-2 md:hidden flex dark:bg-neutral-900",
        className,
      )}
    >
      {items.map((item) => (
  ...
  return (
    <a href={href}>
      ...
      >
        ...
        <motion.div
          style={{ width, height }}
          className="flex items-center justify-center overflow-hidden rounded-full absolute inset-0"
        >
          {icon}
        </motion.div>
      </motion.div>
