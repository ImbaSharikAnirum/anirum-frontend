...
interface DashboardCoursesTableProps {
  className?: string
  filters?: DashboardCoursesFilterValues
  onCourseSelect?: (course: Course | null) => void
  selectedCourse?: Course | null
  refreshKey?: number
  role?: UserRole
  teacherDocumentId?: string // Для автоматической фильтрации по преподавателю
}

export function DashboardCoursesTable({ className, filters, onCourseSelect, selectedCourse, refreshKey, role = 'Manager', teacherDocumentId }: DashboardCoursesTableProps) {
    ...
    <div className={className}>
      <div className="rounded-md border">
        <Table>
          <TableHeader>
            <TableRow>
              {/* Столбец преподаватель только для менеджеров */}
              {role === 'Manager' && <TableHead>Преподаватель</TableHead>}
              <TableHead>Направление</TableHead>
              <TableHead>Дни недели</TableHead>
              <TableHead>Время</TableHead>
              <TableHead>Местоположение</TableHead>
              <TableHead>Участники</TableHead>
              {/* Столбец цена только для менеджеров */}
              {role === 'Manager' && <TableHead>Цена</TableHead>}
