...
interface ManagerCoursesFiltersProps {
  onFiltersChange: (filters: ManagerCoursesFilterValues) => void
  className?: string
}

export interface ManagerCoursesFilterValues {
  teacher: string | null
...
export function ManagerCoursesFilters({ onFiltersChange, className }: ManagerCoursesFiltersProps) {
  ...
  const updateFilters = (newFilters: Partial<ManagerCoursesFilterValues>) => {
